<template>
    <div id="x-friendmgr">
        <div v-if="error">
            <p style="text-align: center; line-height: 128px;">{{errorText}}</p>
        </div>
        <div v-else-if="!contacts.length">
            <p style="text-align: center; line-height: 128px;">
                <span class="fa fa-spin fa-refresh mr-2"></span>加载中...
            </p>
        </div>
        <div class="row px-0 mx-0" v-else>
            <div class="col-sm-5">
                <ul class="list-group">
                    ...
                    <li class="list-group-item" v-for="m of contacts[index].list" :key="m.id">
                        <div class="d-flex flex-row justify-content-between align-items-center">
                            ...
                            <div>
                                <span
                                    title="别名"
                                    @click.stop.prevent="renameFriend(i)"
                                    class="fa-stack"
                                >
                                    <span class="fa fa-circle-thin fa-stack-2x"></span>
                                    <span class="fa fa-pencil fa-stack-1x"></span>
