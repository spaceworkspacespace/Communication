...
mock(new RegExp(`^${LINKS.friend}(\\?.+)?$`), "get", {
    "code": 0,
    "msg": "查询成功!",
    "data|50": [
        {
...
mock(new RegExp(`^${LINKS.friend}(\\?.+)?$`), "post", {
    "msg": "@cword(3,7)",
    "code|1": [0, 1],
});


mock(new RegExp(`^${LINKS.friendGroup}(\\?.+)?$`), "get", {
    "code": 0,
    "msg": "查询成功!",
    "data|6-24": [
        {
...
mock(new RegExp(`^${LINKS.group}(\\?.+)?$`), "get", {
    "code": 0,
    "msg": "查询成功!",
    "data|6-12": [
        {
...
mock(new RegExp(`^${LINKS.group}(\\?.+)?$`), "post", {
    "msg": "@cword(3,7)",
    "code|1": [0, 1],
});


mock(new RegExp(`^${LINKS.group}(\\?.+)?$`), "put", {
    "code": 0,
    "msg": "修改成功!",
    "data": {}
});

mock(new RegExp(`^${LINKS.group}(\\?.+)?$`), "delete", {
    "msg": "@cword(3,7)",
    "code|1": [0, 1],
});

mock(new RegExp(`^${LINKS.groupMember}(\\?.+)?$`), "put", function (options) {
...
mock(new RegExp(`^${LINKS.groupMember}(\\?.+)?$`), "delete", {
    "msg|1": "@cword(3,7)",
    "code|1": [0, 1]
});
